...
#读入CSV数据
#路径名处理
#path_str=u"C:/Users/ll/Desktop/static_amplify.csv"#龙滩他励数据可用
#path_str=u"C:/Users/ll/Desktop/yiyang4_static_amplify.csv"
#path_str=u"C:/Users/ll/Desktop/wqx2_static_amplify.csv"
#path_str=u"C:/Users/ll/Desktop/yongxin1_static_amplify.csv"
path_str=u"C:/Users/ll/Desktop/yongxin2_static_amplify.csv"
...
df=df.rename(columns={u'Ug(p.u.)':u'Ug',u'Uref(p.u.)':u'Uref',u'dU(p.u.)':u'dU',\
                      u'IFD(A)':u'IFD',u'UFD(V)':u'UFD',u'Uavr(p.u.)':u'Uavr',\
...
###############################################################################
#他励下，UL*是定值
Uavr=(UFD+IFD*Xc)/(UFDB.values*UL.values/UTN.values)#*PID_P.values)
###############################################################################
...
#text 
plt.text( (dU_sq.min()+dU_sq.max())*350.0/1000, (Uavr_sq.max()+Uavr_sq.min())*500.0/1000,\
         'y='+str(round(k,5))+'x +'+str(round(h,5)), \
